/*
 * stdio.h - Standard I/O functions for CAST VM
 *
 * This header provides two modes for variadic stdio functions:
 *
 * WITH libffi (CAST_HAS_FFI defined):
...
extern FILE* __cast_stdin(void);
extern FILE* __cast_stdout(void);
extern FILE* __cast_stderr(void);
#define stdin __cast_stdin()
#define stdout __cast_stdout()
#define stderr __cast_stderr()
